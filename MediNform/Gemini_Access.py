    ...
    def __init__(self, age: int):
        ...
        self.med_model = genai.GenerativeModel(
            ...
            system_instruction=(
                ...
                "<T>Disease</T><NM>Provided Name of Disease/Injury</NM><SY>List of Symptoms separated by a comma and no spaces</SY>"
                "<CS>A list of causes separated by a comma with no spaces</CS><TR>A list of treatments separated by a comma with no spaces</TR>\n"
