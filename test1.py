...
med_model = genai.GenerativeModel(
    ...
    system_instruction = "You are a tool made to provide medical information to patients during a consultation with a physician. You will be given a word and you will give accurate medical information to the patient."
    ...
    "If your word is a Drug, output in the following format:\n<T>Drug<T><GNM>Generic drug name</GNM><TNM>Trade drug name</TNM>"
...
while(True):
    ...
    response = med_model.generate_content(medical_term)
    print(response.text)
